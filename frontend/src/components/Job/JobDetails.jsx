...
const JobDetails = () => {
        ...
        return (
                <section className="jobDetail page" style={{ display: 'flex', gap: '20px' }}>
                        <div className="sidebar-ads" style={{ width: '200px', flexShrink: 0 }}>
                                <AdSenseComponent slot="details-sidebar-slot-1" />
                                <AdSenseComponent slot="details-sidebar-slot-2" />
                        </div>
                        <div className="container" style={{ flexGrow: 1 }}>
                                ...
                                <div className="banner">
                                        ...
                                        <AdSenseComponent slot="details-top-slot" format="horizontal" />
                                        <p>
                                        ...
                                        <AdSenseComponent slot="details-middle-slot" />
                                        ...
                                        <AdSenseComponent slot="details-bottom-slot" />
                                </div>
                        </div>
                </section>
        );
